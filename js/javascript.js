...
function init() {
    ...
    myDiagram.nodeTemplateMap.add("Header",  // an overall table header, at the top
        $(go.Part, "Auto",
            ...
            $(go.Shape, { figure: "RoundedRectangle", fill: "transparent", strokeWidth: 0 }),
    ...
    myDiagram.model = new go.GraphLinksModel([
        // headers
        { key: "Header", text: "Temas Estratégicos", category: "Header" },
        { key: "Sider", text: "Perspectivas", category: "Sider" },
        // column and row headers
        { key: "T1", text: "Mejorar la calidad de los activos", col: 2, category: "Column Header" },
        { key: "T2", text: "Lograr la experiencia operacional", col: 3, category: "Column Header" },
        { key: "T3", text: "Lograr crecimiento de ingresos", col: 4, category: "Column Header" },
        { key: "P1", text: "Financiera y Resultados", row: 2, category: "Row Sider" },
        { key: "P2", text: "Clientes", row: 3, category: "Row Sider" },
        { key: "P3", text: "Procesos", row: 4, category: "Row Sider" },
        { key: "P4", text: "Aprendizaje y Crecimiento", row: 5, category: "Row Sider" },
        // cells, each a group assigned to a row and column
        { key: "P1Req", row: 2, col: 2, isGroup: true, color: "lightyellow" },
        { key: "P1App", row: 2, col: 3, isGroup: true, color: "lightgreen" },
        ...
        { key: "Delta", color: "orange", size: "100 100", group: "P1Req" },
        { key: "Epsilon", color: "coral", size: "100 50", group: "P1Req" },
